...
- [x] 3.3 Merge to `master` and confirm the `deploy` job succeeds and the live site is unaffected (run https://github.com/vcasadei/vcasadei.github.io/actions/runs/34708198239; homepage and about page both load 200 live)
